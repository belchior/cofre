const dict = {
  ...
  'auth_by_biometric_desc': [
    'By enabling biometric authentication for logins, you will be prompted to confirm your identity via your device\'s passkey manager.',
    'Habilitando autenticação por Biometria ao iniciar uma sessão, será  solicitado confirmar sua identidade através do gerenciador de chaves de acesso do seu dispositivo.',
  ],
  ...
  'backup_desc': [
    'All data created in this application is encrypted and saved in the browser used to run it; therefore, clearing your browsing history can delete all of the app\'s data.',
    'Todos os dados criados nesta aplicação são criptografados e salvos no navegador usado para executar esta aplicação, sendo assim ao apagar o histórico de navegação é possível excluir todos os dados desta app.',
  ],
  'backup_file_must_be_json': ['The backup file must have the .json extension', 'O arquivo de backup deve possuir a extenção .json'],
  'backup': ['Backup', 'Backup'],
  'cancel': ['cancel', 'cancelar'],
  'choose_auth_method': ['Choose an authentication method', 'Selecione um método de autenticação'],
  'choose_backup_file': ['Choose a backup file', 'Selecione um arquivo de backup'],
  ...
  'export_data': ['export data', 'exportar dados'],
  'favorite': ['Favorite', 'Favorito'],
  'go_back': ['go back', 'voltar'],
  'hide': ['hide', 'esconder'],
  'i_understand_the_risk': ['I understand the risk and want to import', 'Eu entendo o risco e quero importar'],
  'import_backup_file_desc': ['When importing the backup file, all current data will be replaced by the contents of the backup file.', 'Ao importar o arquivo de backup todos os dados atual seram substituidos pelo conteúdo do arquivo de backup.'],
  'import_backup_file': ['Import backup file', 'Importar arquivo de backup'],
  'import_data': ['import data', 'importar dados'],
